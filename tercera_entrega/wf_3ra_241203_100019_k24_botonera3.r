...
FErf_attributes_base <- function( pinputexps, ratio, desvio)
{
  ...
  param_local$train$training <- c( 202102, 202104, 202103, 202105, 202106)
...
wf_3ra_241203_100019_k24_botonera3 <- function( pnombrewf )
{
...
wf_3ra_241203_100019_k24_botonera3 ()

##Amplio el rango entregas de la que mejor performo hasta ahora. mas semillas. botonera2 sin canarios. la 2 no se termino